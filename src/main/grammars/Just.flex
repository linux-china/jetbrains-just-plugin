...
ATTRIBUTE_NAME= env | arg | confirm | default | continue | doc | extension | group | linux | dragonfly | macos | metadata | ("no-cd") | ("exit-message") | ("no-exit-message") | ("no-quieet") | openbsd | ("positional-arguments") | private | parallel | script | unix | windows | shell | ("working-directory")
