...
ATTRIBUTE_NAME= env | arg | confirm | default | continue | doc | extension | group | linux | dragonfly | macos | android | metadata | ("no-cd") | ("exit-message") | ("no-exit-message") | ("no-quiet") | openbsd | ("positional-arguments") | private | parallel | script | unix | windows | shell | ("working-directory") | cache | timestamp
ID_LITERAL=[a-zA-Z_][a-zA-Z0-9_\-]*
SETTING=[a-zA-Z_][a-zA-Z0-9_\-]*
MOD_NAME=[a-zA-Z_][a-zA-Z0-9_\-]*
RECIPE_NAME=[a-zA-Z_][a-zA-Z0-9_\-]*
DEPENDENCY_NAME=[a-zA-Z_][a-zA-Z0-9_\\-]*(::([a-zA-Z_][a-zA-Z0-9_\\-]*))?
SHEBANG=("#!")[^\n]*
COMMENT=("#")[^\n]*
DOUBLE_AND=("&&")
