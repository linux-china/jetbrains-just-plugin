...
ATTRIBUTE_NAME= env | arg | confirm | default | continue | doc | extension | group | linux | dragonfly | macos | android | metadata | ("no-cd") | ("exit-message") | ("no-exit-message") | ("no-quiet") | openbsd | ("positional-arguments") | private | parallel | script | unix | windows | shell | ("working-directory")
